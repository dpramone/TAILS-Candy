...
#########################################################################
# TAILS Generate more secure OpenSSH moduli-file
#
...
/usr/bin/sudo -u amnesia /usr/bin/notify-send -i gnome-app-install "OpenSSH Upgraded" "OpenSSH moduli-file upgraded to 4096-bit values"
